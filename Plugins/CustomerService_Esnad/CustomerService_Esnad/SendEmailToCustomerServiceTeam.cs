...
namespace CustomerService_Esnad
    {
        ...
        {
            //send email to CRM officer of CST created ticket
            public void Execute(IServiceProvider serviceProvider)
            {
                ...
                var caseEntity = service.Retrieve("incident", caseId, new ColumnSet("title", "new_assignedspecializedteam", "prioritycode"));
       ...
       <body>
         ...
         <p><img src='{imageUrl}' alt='CRM Logo' style='max-width: 200px;' /></p>
                ...
                var email = new Entity("email")
                    {
                        ["subject"] = $"New Ticket Assigned to Customer Service Team",
