...
{
    public class ProcessingLeval1 : IPlugin
    {
        // Adjust these constants as needed
        private const string NotificationFieldLogicalName = "new_notificationusersprocessingl1";
        private const string RoleNameToFind = "KI: Relationship Manager"; // change if a different role is required
       ...
       // private static readonly Guid RoleIdToFind = new Guid("98E0066B-FEBE-F011-A42B-C842AD1D2D99");//Prod
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            tracing.Trace("ProcessingLeval1 started.");
            ...
            try
            {
                ...
                // Retrieve incident fields required
                ...
                {
                    ["subject"] = $"[Processing SLA Escalation Level 1 - KI: Relationship Manager] - Case Breach Alert",
                ...
                tracing.Trace("ProcessingLeval1 completed.");
            }
            catch (Exception ex)
            {
                tracing.Trace("Plugin error: " + ex.ToString());
                throw new InvalidPluginExecutionException("Error in ProcessingLeval1 plugin.", ex);
            }
        }
