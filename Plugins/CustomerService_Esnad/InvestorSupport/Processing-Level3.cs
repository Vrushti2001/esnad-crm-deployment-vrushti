...
namespace InvestorSupport
{
    ...
    {
        // Config
        private const string NotificationFieldLogicalName = "new_notificationusersprocessingl3";
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            tracing.Trace("ProcessingLevel3 started.");
            ...
            try
            {
                ...
                {
                    tracing.Trace("Owner is a team — fetching sector heads in that team.");
                ...
                {
                    tracing.Trace("Owner is a user — fetching user's teams and gathering sector heads.");
                ...
                {
                    tracing.Trace("No recipients found for Level 3 escalation — exiting without sending email.");
                    return;
                }

                // Persist recipients joined string to incident (non-blocking)
                ...
                {
                    ["subject"] = $"[Processing SLA Escalation Level 3 - KI: Sector Head] - Case Breach Alert",
                ...
                tracing.Trace("ProcessingLevel3 completed.");
            }
            catch (Exception ex)
            {
                tracing.Trace("Plugin error: " + ex.ToString());
                throw new InvalidPluginExecutionException("Error in ProcessingLevel3 plugin.", ex);
            }
        }
