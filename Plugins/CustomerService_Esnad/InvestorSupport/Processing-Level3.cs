...
namespace InvestorSupport
    {
        public class ProcessingLevel3 : IPlugin
        {
            ...
            private const string RoleNameToFind = "KI: Sector Head"; //"KI: Relationship Management Sector Head";
            ...
            public void Execute(IServiceProvider serviceProvider)
            {
                ...
                try
                {
                    ...
                    {
                        ["subject"] = $"[Assignment SLA Escalation Level 2 - KI: Department Manager] - Case Breach Alert",
